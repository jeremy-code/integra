...
The web application is located on [integra.pages.dev](https://integra.pages.dev/), hosted with [Cloudflare Pages](https://pages.cloudflare.com/). The GraphQL Express API server is hosted on [integra.fly.dev](https://integra.fly.dev/) with [fly.io](https://fly.io/).
